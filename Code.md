...
public class Main {
    ...
    static void addStudent() {
        ...
        if (average >= 90) remark = "Excellent";
        else if (average >= 80) remark = "Very Good";
        else if (average >= 70) remark = "Good";
        else if (average >= 60) remark = "Needs Improvement";
        else remark = "Fail";
    ...
    static void viewStudents() {
        ...
        for (Student s : students) {
            System.out.printf("%-10s %-20s %-8.2f %-15s%n",
